...
const Backshift = require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!backshift/dist/backshift.onms');
const holder = require('holderjs');

require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot/jquery.flot');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot/jquery.flot.time');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot/jquery.flot.canvas');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot/jquery.flot.navigate');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot-legend/jquery.flot.legend');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot.axislabels');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!jquery.flot.tooltip/js/jquery.flot.tooltip');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot.saveas');
require('imports-loader?jQuery=vendor%2Fjquery-js,$=vendor%2Fjquery-js!flot-datatable/jquery.flot.datatable.js');
