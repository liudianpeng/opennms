...
(function() {
  ...
  const assetView = require('ngtemplate-loader!../../views/asset.html');
  const interfaceView = require('ngtemplate-loader!../../views/interface.html');

  const nodeBasicView = require('ngtemplate-loader!../../views/node-basic.html');
  const nodePathoutagesView = require('ngtemplate-loader!../../views/node-pathoutages.html');
  const nodeInterfacesView = require('ngtemplate-loader!../../views/node-interfaces.html');
  const nodeAssetsView = require('ngtemplate-loader!../../views/node-assets.html');
  const nodeCategoriesView = require('ngtemplate-loader!../../views/node-categories.html');
