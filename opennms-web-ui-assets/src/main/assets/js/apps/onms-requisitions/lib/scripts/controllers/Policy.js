...
(function() {
  ...
  const policyParamOptionsView = require('ngtemplate-loader!../../views/policy-param.options.html');
  const policyParamStringView = require('ngtemplate-loader!../../views/policy-param.string.html');
  const policyParamFixedView = require('ngtemplate-loader!../../views/policy-param.fixed.html');
  const policyParamEditableView = require('ngtemplate-loader!../../views/policy-param.editable.html');
