...
(function() {
  ...
  const quickAddNodeView = require('ngtemplate-loader!../../views/quick-add-node.html');
  const cloneForeignsourceView = require('ngtemplate-loader!../../views/clone-foreignsource.html');
