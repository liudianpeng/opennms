...
(function() {
  ...
  const policyView = require('ngtemplate-loader!../../views/policy.html');
  const moveView = require('ngtemplate-loader!../../views/move.html');
  const detectorView = require('ngtemplate-loader!../../views/detector.html');
