...
const filterTemplate            = require('ngtemplate-loader!./templates/filter.html');
const paginationToolbarTemplate = require('ngtemplate-loader!./templates/pagination-toolbar.html');
const severityFilterTemplate    = require('ngtemplate-loader!./templates/severity-filter.html');

const applicationsTemplate      = require('ngtemplate-loader!./views/applications.html');
const businessServicesTemplate  = require('ngtemplate-loader!./views/business-services.html');
const nodesTemplate             = require('ngtemplate-loader!./views/nodes.html');
const unknownTemplate           = require('ngtemplate-loader!./views/unknown.html');
