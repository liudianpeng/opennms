...
function createConfig(options) {
  ...
  myconf.plugins.push(new webpack.optimize.CommonsChunkPlugin({
    ...
    filename: getFile('[name]-[chunkhash:7]', options),
    minChunks: Infinity
  }));
  */
  /*
  ...
  */
  ...
  myconf.output.filename = getFile('[name]-[chunkhash:7]', options);
  myconf.output.chunkFilename = getFile('[name]-[chunkhash:7]', options);
